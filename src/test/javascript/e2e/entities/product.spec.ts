...
describe('Product e2e test', () => {
    ...
    it('should load Products', () => {
        ...
        expect(productComponentsPage.getTitle()).toMatch(/gatewayApp.product.home.title/);
    ...
    it('should load create Product dialog', () => {
        ...
        expect(productDialogPage.getModalTitle()).toMatch(/gatewayApp.product.home.createOrEditLabel/);
